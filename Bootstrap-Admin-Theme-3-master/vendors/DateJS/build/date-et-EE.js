...
(function () {
    ...
    $D.getMonthNumberFromName = function (name) {
        var n = Date.CultureInfo.monthNames,
            m = Date.CultureInfo.abbreviatedMonthNames, s = name.toLowerCase();
        for (var i = 0; i < n.length; i++) {
...
(function () {
    ...
    var _ = $P.Operators = {
        ...
        cache: function (rule) {
            var cache = {}, cache_length = 0, cache_keys = [],
                CACHE_MAX = Date.Config.CACHE_MAX || 100000, r = null;
        ...
        set: function (px, d, c) {
            ...
            return function (s) {
                ...
                var r = null, p = null, q = null, rx = null, best = [[], s],
                    last = false;
